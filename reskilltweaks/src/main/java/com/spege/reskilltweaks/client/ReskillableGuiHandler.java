package com.spege.reskilltweaks.client;
...
public class ReskillableGuiHandler {
    ...
    private static Field findField(String name) {
        try {
            ...
            ReskillTweaks.LOGGER.error("[ReskillTweaks] Failed to access Reskillable GuiSkillInfo field '{}'.", name,
                    e);
            return null;
        }
    }
    ...
    public void onDrawScreen(GuiScreenEvent.DrawScreenEvent.Post event) {
        ...
        Minecraft mc = Minecraft.getMinecraft();
        String hint = I18n.format("reskilltweaks.reskillable.lock_fallback");
        ...
        try {
            ...
            if (!loggedReflectionFailure) {
                ...
                ReskillTweaks.LOGGER.error(
                        "[ReskillTweaks] Failed to read Reskillable GuiSkillInfo fields. Disabling GUI refund fallback.",
                        e);
            }
            return null;
        }
