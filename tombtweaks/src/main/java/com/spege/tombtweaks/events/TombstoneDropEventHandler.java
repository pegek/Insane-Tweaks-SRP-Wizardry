...
public class TombstoneDropEventHandler {
    ...
    public void onLivingDrops(LivingDropsEvent event) {
        if (!com.spege.tombtweaks.config.TombTweaksConfig.tombstone.enableTombstoneTweaks || !com.spege.tombtweaks.config.TombTweaksConfig.tombstone.nerfGraveDustDrop) {
            return;
        }
        ...
        int dropChance = com.spege.tombtweaks.config.TombTweaksConfig.tombstone.graveDustDropChance;
