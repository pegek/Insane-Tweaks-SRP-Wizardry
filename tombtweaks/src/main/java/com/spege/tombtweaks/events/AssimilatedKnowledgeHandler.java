...
import com.spege.tombtweaks.perks.PerkAssimilatedKnowledge;
import com.spege.tombtweaks.util.TombstonePerkHelper;
...
public class AssimilatedKnowledgeHandler {
    ...
    public void onLivingDeath(LivingDeathEvent event) {
        ...
        AssimilatedKnowledgeConfig cfg = TombTweaksConfig.tombstone.assimilatedKnowledge;
        if (!TombTweaksConfig.tombstone.enableTombstoneTweaks || !cfg.enabled || cfg.maxLevel <= 0) {
            return;
        }
        ...
        if (cfg.debugLogging) {
            TombstoneTweaks.LOGGER.info(
                    "[TombstoneTweaks] Assimilated Knowledge: {} killed {} at perk level {} (chance {}) -> {}",
