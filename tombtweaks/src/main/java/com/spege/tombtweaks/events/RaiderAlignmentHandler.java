...
import com.spege.tombtweaks.config.categories.TombstoneCategory.RaiderAlignmentConfig;
...
public class RaiderAlignmentHandler {
    ...
    public void onLivingDeath(LivingDeathEvent event) {
        ...
        RaiderAlignmentConfig cfg = TombTweaksConfig.tombstone.raiderAlignment;
        ...
        if (cfg.debugLogging) {
            TombstoneTweaks.LOGGER.info("[TombstoneTweaks] Raider kill: {} killed {} for {} alignment.",
