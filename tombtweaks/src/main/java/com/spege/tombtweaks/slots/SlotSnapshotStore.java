...
public final class SlotSnapshotStore {
    ...
    /**
     * NBT key in the player's persisted data. Deliberately still the Insane Tweaks name: a player
     * who died before the R4 split and recovers their grave after it keeps the layout they died in.
     */
