package com.spege.tombtweaks.config.categories;
...
public class TombstoneCategory {
    ...
    @Config.Comment({
            ...
            "Use /tombtweaks restore cursed <player> to view/restore backups."
    })
    ...
    @Config.Comment({
            "Tell the dying player, in chat, what the Curse of Possession check found and took.",
            "Worth turning on while deciding whether the name match is catching the right items;",
            "noisy otherwise, since it also reports the deaths where it found nothing."
    })
    ...
    @Config.Comment({
            ...
            "Use /tombtweaks restore decay <player> to view/restore items lost to grave decay."
    })
