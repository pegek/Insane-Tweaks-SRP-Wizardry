...
public class ModConfig {
    ...
    public static class Traits {
        ...
        public TraitConfig assimilatedWarfare = new TraitConfig(6, "attack", new String[] { "reskillable:attack|18" });

        @Config.Name("Spider's Grace")
        public TraitConfig spidersGrace = new TraitConfig(7, "defense", new String[] { "reskillable:defense|35" });

        @Config.Name("Iron Stomach")
        public TraitConfig ironStomach = new TraitConfig(5, "defense", new String[] { "reskillable:defense|15" });

        @Config.Name("Double Loot")
        public TraitConfig doubleLoot = new TraitConfig(5, "gathering", new String[] { "reskillable:gathering|10" });
        ...
        public TraitConfig astralProspector = new TraitConfig(7, "mining", new String[] { "reskillable:mining|30" });
        ...
        public TraitConfig bobTheBuilder = new TraitConfig(5, "building", new String[] { "reskillable:building|18" });

        @Config.Name("Angry Farmer")
        public TraitConfig angryFarmer = new TraitConfig(10, "farming", new String[] { "reskillable:farming|45" });

        @Config.Name("Adapted Vegetation")
        public TraitConfig adaptedVegetation = new TraitConfig(5, "farming", new String[] { "reskillable:farming|18" });
        ...
        public TraitConfig schoolOfAlteration = new TraitConfig(5, "magic", new String[] { "reskillable:magic|28" });

        @Config.Name("School of Conjuration")
        public TraitConfig schoolOfConjuration = new TraitConfig(5, "magic", new String[] { "reskillable:magic|22" });

        @Config.Name("School of Destruction")
        public TraitConfig schoolOfDestruction = new TraitConfig(5, "magic", new String[] { "reskillable:magic|22" });
