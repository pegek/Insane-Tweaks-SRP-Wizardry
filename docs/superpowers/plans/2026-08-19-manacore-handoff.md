...
- **Pozostałe efekty many nadal celują w manę itemu**: bonus setowy SpellBundle, mana leech Necromancer's Delight, ArcaneApprentices. (ASC `PotionManaRegeneration` i `meditation` są już przepięte — patrz punkt wyżej.) Faza 5.
