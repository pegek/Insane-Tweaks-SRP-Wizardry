...
public class LivingWarlockArmorItem extends ItemWizardArmour implements ITweaksPropertyHolder {
    ...
    public LivingWarlockArmorItem(EntityEquipmentSlot slot) {
    ...
    public List<String> getActiveAdvProperties(ItemStack stack) {
        return Arrays.asList(AdvPropertyRegistry.ASHEN_LEGACY, AdvPropertyRegistry.ARMOR_LAST_STAND);
    }
}
