...
public class SentientWarlockArmorItem extends ItemWizardArmour implements ITweaksPropertyHolder {
    ...
    public SentientWarlockArmorItem(EntityEquipmentSlot slot) {
        super(ItemWizardArmour.ArmourClass.WARLOCK, slot, null);
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot equipmentSlot, ItemStack stack) {
        ...
        if (equipmentSlot == this.armorType) {
            ...
            customArmor *= cfg.sentientWarlockArmorMultiplier;
            customToughness *= cfg.sentientWarlockToughnessMultiplier;
    ...
    public void applySpellModifiers(EntityLivingBase caster, Spell spell, SpellModifiers modifiers) {
        // Flat 3% discount per piece, scaled by the shared armour spell-discount multiplier.
        float multiplier = 1.0f - 0.03f
    ...
    public List<String> getActiveAdvProperties(ItemStack stack) {
        ...
        if (nbt != null) {
            absorbed = nbt.getFloat("ArmorDamageBlocked");
        }
        String shell = absorbed >= 10000.0f ? AdvPropertyRegistry.ETHEREAL_SHELL_AWAKENED : AdvPropertyRegistry.ETHEREAL_SHELL;
        return Arrays.asList(AdvPropertyRegistry.ASHEN_LEGACY, AdvPropertyRegistry.ARMOR_LAST_STAND, shell);
    }
}
