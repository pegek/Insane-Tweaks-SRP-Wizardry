...
import com.spege.insanetweaks.config.categories.TombstoneCategory.EffectPoolsConfig;
 ...
 * {@code insanetweaks.cfg → tombstone.effectpools}.
 *
...
public final class EffectPoolRegistry {
    ...
    public static boolean isActive() {
        return ModConfig.tombstone.enableTombstoneTweaks
                && ModConfig.tombstone.effectPools.enableEffectWhitelist;
    }
    ...
    private static Map<EffectPoolId, List<EffectPoolEntry>> build() {
        EffectPoolsConfig cfg = ModConfig.tombstone.effectPools;
        ...
        InsaneTweaksMod.LOGGER.info(
                "[InsaneTweaks] Tombstone effect whitelist built: {} beneficial, {} harmful, {} magic scroll (enabled={}).",
        ...
        for (String line : raw) {
            ...
            if (potion == null) {
                InsaneTweaksMod.LOGGER.warn(
                        "[InsaneTweaks] Tombstone effect whitelist: '{}' in {} is not a registered potion effect — skipping it.",
                        name, poolName);
                continue;
            }
    ...
    private static int parseInt(String[] parts, int index, int fallback, int min, String name,
        ...
        try {
            ...
            if (value < min) {
                InsaneTweaksMod.LOGGER.warn(
                        "[InsaneTweaks] Tombstone effect whitelist: {} '{}' for '{}' in {} is below {} — using {}.",
            ...
            InsaneTweaksMod.LOGGER.warn(
                    "[InsaneTweaks] Tombstone effect whitelist: '{}' is not a valid {} for '{}' in {} — using {}.",
